...
| --- | --------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | -------------- |
| 2   | - Tìm hiểu thư viện sinh PDF có thể dùng trong Lambda (theo runtime của dự án)                                                | 15/06/2026   | 15/06/2026      |                |
...
* Hoàn thành Lambda Report Processor: nhận kết quả AI từ SQS và sinh báo cáo PDF tự động.
* Lưu trữ báo cáo PDF trên S3 (Report Bucket) với cấu trúc đặt tên rõ ràng.
* Cấu hình thành công lifecycle rule tự động chuyển object sang S3 Glacier sau 30 ngày, giúp giảm chi phí lưu trữ dài hạn.
* ...
