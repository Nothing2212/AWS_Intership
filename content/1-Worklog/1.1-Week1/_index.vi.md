...
* Nắm được lộ trình thực tập (17/04/2026 - 30/07/2026), nội quy và quy trình báo cáo worklog.
...
| 7   | - Xem lại note buổi onboarding chi tiết hơn, tự vẽ lại sơ đồ phân chia trách nhiệm giữa AWS và khách hàng theo Shared Responsibility Model cho từng nhóm dịch vụ (một số ranh giới trách nhiệm ở nhóm Networking còn nhầm lẫn, phải xem lại tài liệu vài lần mới rõ), chuẩn bị tạo AWS Free Tier account cho tuần sau | 18/04/2026   | 18/04/2026      |                                               |
...
* Bước đầu xây dựng được mô hình tư duy về hạ tầng toàn cầu của AWS (Region/AZ đảm bảo tính sẵn sàng cao, Edge Location phục vụ CDN) và mô hình Shared Responsibility Model (AWS chịu trách nhiệm bảo mật "của" cloud, khách hàng chịu trách nhiệm bảo mật "trong" cloud), dù một số ranh giới trách nhiệm cụ thể (đặc biệt ở nhóm Networking) vẫn cần đọc thêm để hiểu sâu hơn.
* Có cái nhìn tổng quan ở mức cơ bản về các nhóm dịch vụ chính của AWS và cách một workload thực tế thường kết hợp chúng với nhau:
...
* Nhìn chung nắm được kiến thức nền tảng ở mức khá, chưa đi sâu vào từng dịch vụ cụ thể — dự kiến sẽ củng cố thêm qua thực hành ở các tuần tiếp theo.
