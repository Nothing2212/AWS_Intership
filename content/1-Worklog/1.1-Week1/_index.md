...
| Sat | - Reviewed notes from the onboarding session in detail, mapped out how the Shared Responsibility Model splits duties between AWS and the customer for each service group, and prepared to create an AWS Free Tier account for next week | 18/04/2026 | 18/04/2026      |                                               |
...
* Built a solid mental model of AWS's global infrastructure (Regions/AZs for high availability, Edge Locations for CDN) and the Shared Responsibility Model (AWS secures "of the cloud", the customer secures "in the cloud").
* Gained an overview of AWS's main service groups and how a typical workload combines them:
