...
| 5   | - **Thực hành:** tạo CloudFront distribution cho website tĩnh trên S3 sử dụng OAC (thay vì để bucket public), kiểm chứng rằng bucket gốc không thể truy cập trực tiếp nữa                                | 21/05/2026   | 21/05/2026      | <https://cloudjourney.awsstudygroup.com/vi/> |
...
* Triển khai CloudFront distribution phía trước static website trên S3 sử dụng Origin Access Control, khóa quyền truy cập public trực tiếp vào bucket trong khi vẫn phục vụ nội dung nhanh qua HTTPS nhờ edge caching.
