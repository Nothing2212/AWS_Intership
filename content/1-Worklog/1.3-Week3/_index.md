...
| Tue | - **Practice:** create a bucket, upload/download objects via console and CLI <br> - Configure versioning (and understand why it protects against accidental deletes/overwrites) & permissions (bucket policy vs IAM policy vs ACL, and the precedence between them) | 28/04/2026 | 28/04/2026      | <https://cloudjourney.awsstudygroup.com/vi/> |
