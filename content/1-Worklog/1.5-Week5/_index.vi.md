...
| 3   | - **Thực hành:** tạo Application Load Balancer, target group, health check; lần đầu đặt ngưỡng unhealthy threshold quá thấp nên target bị đánh dấu unhealthy và loại khỏi load balancer chỉ vì một lần phản hồi chậm (false positive), phải tăng ngưỡng và khoảng thời gian cho hợp lý hơn                                          | 12/05/2026   | 12/05/2026      | <https://cloudjourney.awsstudygroup.com/vi/> |
...
* Triển khai thành công Application Load Balancer với target group và health check; sau khi tự gặp sự cố target bị loại khỏi LB do đặt ngưỡng quá nhạy, hiểu rõ hơn cách khoảng thời gian/ngưỡng health check đánh đổi giữa tốc độ failover và nguy cơ báo động giả (false positive).
