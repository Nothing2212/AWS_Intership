...
| Tue | - **Practice:** create an Application Load Balancer, target group, and health check; tune the health-check threshold/interval and observe how it affects failover speed                     | 12/05/2026 | 12/05/2026      | <https://cloudjourney.awsstudygroup.com/vi/> |
...
* Successfully deployed an Application Load Balancer with a target group and health check, and understood how the health-check interval/threshold trades off failover speed against false positives.
